...
public class ViewAppointmentServlet extends HttpServlet {
	private static final String query = "SELECT APPOINTMENT_ID, PATIENT_NAME ,PATIENT_EMAIL,DOCTOR_NAME,APPOINTMENT_DATE,DESCRIPTION FROM CLIENT";
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String host = "jdbc:derby://localhost:1527/Hospital_System;create=true";
        String uName = "admin";
        String uPass= "admin";
		//generate the conn
		try(Connection con = DriverManager.getConnection(host, uName, uPass);
			...
			while(rs.next()) {
				...
				pw.println("<td><a href='user_edit_appointment.jsp?id="+rs.getInt(1)+"'</a>EDIT</td>");
